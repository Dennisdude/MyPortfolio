    ...
    return <section id="projects" className="py-24 px-4 relative">
        <div className="container mx-auto max-w-5xl">
                        ...
                        <div className="p-6">
                            <div className="flex flex-wrap gap-2 mb-4">
                                {project.tags.map((tag, key) => (
                                    <span key={key} className="px-2 py-1 font-medium border rounded-full">{tag}</span>
                                ))}
                            </div>
                            ...
                            <div className="flex justify-center">
                                <div className="flex space-x-3">
                                    ...
                                    <a href={project.githubUrl} target="_blank" className="text-foreground/80 hover:text-primary transition-colors duration-300">
                                        <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor">
                                            <title>GitHub</title>
            ...
            <div className="text-center mt-12">
                <a href="https://github.com/Dennisdude" target="_blank" className="cosmic-button w-fit flex items-center mx-auto gap-2">
